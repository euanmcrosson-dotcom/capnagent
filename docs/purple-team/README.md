...
| 11 | Indirect injection cascade via tool response (runtime sibling of round 01) | OWASP LLM01, CWE-441 | CLOSED 2026-05-03 | 2026-11-03 | chain ✓ caveat ✗ (on follow-on call) |
| 12 | Capability re-issuance after denial (operator runbook, not structural) | n/a — operator-policy round | CLOSED 2026-05-03 | 2026-11-03 | contract-shape round; gates not the framing |
